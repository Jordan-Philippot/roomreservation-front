...
// Services
import { getDefaultUser } from '../services/axios/user'

// Images 
import UserImage from '../images/AvatarMaker.png'
...
export default function Profile() {
    ...
    useEffect(() => {
        setLoading(true)
        getDefaultUser(setUser, setLoading)
    ...
    return (
        <div id="apartment-details">
            ...
            <Cursor />
            <div>
                <h1>Consultez les détails de votre profil</h1>
            </div>

            {loading ? <Loader /> : user ?
                <div className="apartment">

                    <img className="apartment-image" src={UserImage} alt="vue extérieur d'un hôtel" />

                    <p className="apartment-name">{user?.firstname} {user?.lastname}</p>
                    ...
                    <div className="apartment-address">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-calendar4-event" viewBox="0 0 16 16">
                    ...
                    <div classNameName="apartment-address">
                    ...
                    <div classNameName="apartment-address">
                        ...
                        <p>{user.administrator ? 'admin' : 'invité'}</p>
                    </div>

                </div>
                : <p className="alert alert-success no-data">Aucun utilisateur n'a été trouvé</p>
            }
